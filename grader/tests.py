...
class ControllerGrader(PySTKGrader, Grader):
    ...
    def test_lighthouse(self):
        """lighthouse"""
        # print('Testing lighthouse', self._test('lighthouse', 550))
        return self._test('lighthouse', 550)

    @Case(score=5)
    def test_hacienda(self):
        """hacienda"""
        # print('Testing hacienda', self._test('hacienda', 700))
        return self._test('hacienda', 700)

    @Case(score=5)
    def test_snowtuxpeak(self):
        """snowtuxpeak"""
        # print('Testing snowtuxpeak', self._test('snowtuxpeak', 700))
        return self._test('snowtuxpeak', 700)

    @Case(score=5)
    def test_zengarden(self):
        """zengarden"""
        # print('Testing zengarden', self._test('zengarden', 600))
        return self._test('zengarden', 600)

    @Case(score=5)
    def test_cornfield_crossing(self):
        """cornfield_crossing"""
        # print('Testing cornfield_crossing', self._test('cornfield_crossing', 750))
        return self._test('cornfield_crossing', 750)

    @Case(score=5)
    def test_scotland(self):
        """scotland"""
        # print('Testing scotland', self._test('scotland', 700))
...
class PlannerGrader(PySTKGrader, Grader):
    ...
    def test_lighthouse(self, it=0):
        """lighthouse"""
        # print('Testing lighthouse', self._test('lighthouse', 650))
    ...
    def test_zengarden(self, it=0):
        """zengarden"""
        # print('Testing zengarden', self._test('zengarden', 700))
        return self._test('zengarden', 700)

    @Case(score=10)
    def test_cornfield_crossing(self, it=0):
        """cornfield_crossing"""
        # print('Testing cornfield_crossing', self._test('cornfield_crossing', 950))
        return self._test('cornfield_crossing', 950)

    @Case(score=10)
    def test_scotland(self, it=0):
        """scotland"""
        # print('Testing scotland', self._test('scotland', 850))
...
class NewLevelrGrader(PySTKGrader, Grader):
    ...
    def test_cocoa_temple(self, it=0):
        """cocoa temple"""
        # print('Testing cocoa_temple', self._test('cocoa_temple', 800))
